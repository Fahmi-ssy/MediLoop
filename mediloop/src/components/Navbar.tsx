...
export default function Navbar() {
  return (
    <header className="relative flex border-b py-4 sm:px-8 px-6 font-[sans-serif] min-h-[80px] tracking-wide z-50">
      ...
      />
      <div className="flex flex-wrap items-center lg:gap-y-2 gap-4 w-full relative">
        ...
        <div className="flex gap-x-6 gap-y-4 ml-auto">
          <div className="flex border-2 focus-within:border-slate-700 border-slate-500 rounded-full px-6 py-3 overflow-hidden max-w-52 max-lg:hidden">
            <input
              type="text"
              placeholder="Search something..."
              className="w-full text-sm bg-transparent text-slate-950 outline-none pr-2"
            />
            <svg
              xmlns="http://www.w3.org/2000/svg"
